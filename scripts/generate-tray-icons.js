...
/**
 * Generate tray icons for Windows, Linux and macOS from a source logo.
 * Uses ImageMagick (magick or convert command) for image processing.
 *
 * Outputs:
 *   resources/tray/tray-icon.ico        – Windows ICO (16, 32, 48px embedded)
 *   resources/tray/tray-icon.png        – Linux PNG (48px)
 *   resources/tray/trayIconTemplate.png     – macOS template 18px
 *   resources/tray/trayIconTemplate@2x.png  – macOS template 36px (2x)
 *   resources/tray/tray-icon-mac.png         – macOS color 18px
 *   resources/tray/tray-icon-mac@2x.png     – macOS color 36px (2x)
 */
...
function main() {
  ...
  // macOS template images: convert the logo to opaque pixels for menu bar
  run(magick, [
